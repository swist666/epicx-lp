...
function CallToAction() {
    return (
        <div className="relative pt-20 pb-16 text-center sm:py-24">
            <hgroup>
                <Subheading>Przyszłość bloku operacyjnego dzieje się teraz.</Subheading>
                <p className="mt-6 text-3xl font-medium tracking-tight text-gray-950 sm:text-5xl">
                    Nasze rozwiązanie już dziś wspiera szpitale publiczne i prywatne, eliminując chaos i wprowadzając pełną cyfryzację operacji. Dołącz do grona liderów, którzy zmieniają sposób pracy w ochronie zdrowia.
                </p>
            </hgroup>
            <div className="mt-6">
                ...
                <Container>
                    ...
                    <PlusGrid className="pb-16">
                        <PlusGridRow className="flex justify-between">
                            <div>
                                <PlusGridItem className="py-3 px-4 flex">
                                    <Copyright />
                                </PlusGridItem>
                            </div>
